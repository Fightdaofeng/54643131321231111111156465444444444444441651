...
public class ImageLoaderUtil {
	public static void getImage(Context context, ImageView v, String iamgeUrl,
	...
	public static void getImage(Context context, ImageView v, String iamgeUrl,
		...
		try {
			...
			Log.d("imageSize", "width>>" + imageSize.width + "height>>"
					+ imageSize.height);
			imageLoader.get(iamgeUrl, listener, imageSize.width,
					imageSize.height);
