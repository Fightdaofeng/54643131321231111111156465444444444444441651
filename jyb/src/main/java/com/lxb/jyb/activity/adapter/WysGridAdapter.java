...
public class WysGridAdapter extends BaseAdapter {

	private ArrayList<CalSXItem> list;
	private Context context;
	private MyClickListener clickListener;

	public WysGridAdapter(ArrayList<CalSXItem> list, Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(
					R.layout.wys_griditem, null);
			holder.tv = (TextView) convertView.findViewById(R.id.wys_grid_tv);
			holder.img = (ImageView) convertView
					.findViewById(R.id.wys_grid_img);
